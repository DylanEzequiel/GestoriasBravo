...
function WhyUs():React.ReactElement {
  return (
    <div className='md:px-10 py-20' id='nosotros'>  
      ...
      <article className='flex md:flex-row flex-col flex-wrap justify-center gap-4 lg:gap-10'>
         ...
         <motion.div 
          ...
          viewport={{ once: true }}
         className='group flex flex-col self-center gap-4 bg-white shadow-md hover:shadow-blue-950 p-2 border-b-2 border-b-blue-700 w-48 text-center hover:-translate-y-1 duration-200'>
        ...
        <motion.div
          ...
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          viewport={{ once: true }} className='group flex flex-col self-center gap-4 bg-white shadow-md hover:shadow-blue-950 p-2 border-b-2 border-b-blue-700 w-48 text-center hover:-translate-y-1 duration-200'>
