...
function Home():React.ReactElement {
  return (
    <article className='flex flex-row justify-center py-20 h-svh'>
        <main className='flex flex-col justify-start gap-3 pl-24 md:w-[75%] self-center'>
            <h2 className='flex flex-col font-semibold text-3xl text-balance text-sky-950'>
                <span>Welcome to Gestorías Bravo</span>
                <span className='text-4xl'>Your Trusted Insurance Partner</span></h2>
