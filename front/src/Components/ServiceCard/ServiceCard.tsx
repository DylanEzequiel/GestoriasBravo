...
function ServiceCard({image,title}:IService):React.ReactElement {
  return (
    <div className='group flex flex-row gap-2 bg-white shadow-black/30 shadow-xl hover:shadow-black/50 m-auto md:m-4 my-4 p-2 rounded-md w-64 md:w-auto h-28 duration-200'>
