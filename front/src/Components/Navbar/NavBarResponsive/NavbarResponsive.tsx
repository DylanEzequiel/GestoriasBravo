    ...
    return (
        <div className='lg:hidden'>
            <div onClick={() => setRender(!render)} className='hover:cursor-pointer'>
                <TiThMenu size={30} className='self-center text-white transition-all duration-200' />
            </div>
            {render ?
                <>
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        transition={easeIn}
                        className={`fixed inset-y-0 right-0 top-12 z-40 w-screen h-screen backdrop-blur-sm bg-gray-300/20  shadow-lg`}
